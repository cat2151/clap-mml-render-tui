...
use crate::playback::position::PlaybackBeat;

use cmrt_tui_core::status::base_style;
use cmrt_tui_core::theme::MONOKAI_CYAN;

pub const ACTIVE_BEAT_BG: Color = Color::Rgb(78, 65, 35);

pub fn title(position: Option<PlaybackBeat>) -> String {
...
pub fn marker_style(style: Style) -> Style {
