...
use cmrt_server_config::{
    HIHAT_KEYWORDS as DEFAULT_HIHAT_PATCH_KEYWORDS, KICK_KEYWORDS as DEFAULT_KICK_PATCH_KEYWORDS,
    SNARE_KEYWORDS as DEFAULT_SNARE_PATCH_KEYWORDS,
    SURGE_ARPEGGIO_CATEGORIES as DEFAULT_ARPEGGIO_PATCH_CATEGORY_NAMES,
    SURGE_BASS_CATEGORIES as DEFAULT_BASS_PATCH_CATEGORY_NAMES,
    SURGE_CHORD_CATEGORIES as DEFAULT_CHORD_PATCH_CATEGORY_NAMES,
    SURGE_DRUM_CATEGORIES as DEFAULT_DRUM_PATCH_CATEGORY_NAMES,
    VAPORIZER2_ARPEGGIO_CATEGORIES as VAPORIZER2_ARPEGGIO_CATEGORY_NAMES,
    VAPORIZER2_BASS_CATEGORIES as VAPORIZER2_BASS_CATEGORY_NAMES,
    VAPORIZER2_CATEGORY_CODES as VAPORIZER2_PATCH_CATEGORY_CODES,
    VAPORIZER2_CHORD_CATEGORIES as VAPORIZER2_CHORD_CATEGORY_NAMES,
    VAPORIZER2_DRUM_CATEGORIES as VAPORIZER2_DRUM_CATEGORY_NAMES,
};
...
///
/// 表はserver-configが単一ソース。ここへ書き写すと、コードを足したときに
/// ひな形だけ古いまま残る。
