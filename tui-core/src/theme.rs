//! UI テーマ定義（TUI / DAW / loop browser 共通）。
...
pub const MONOKAI_CYAN: Color = Color::Rgb(102, 217, 239);
pub const MONOKAI_PURPLE: Color = Color::Rgb(174, 129, 255);
pub const MONOKAI_CURSOR_BG: Color = Color::Rgb(73, 72, 62);
...
pub fn cursor_highlight_bg(fg: Color) -> Color {
...
pub fn cursor_highlight_style(style: Style) -> Style {
