...
pub fn new_single_line_textarea<'a>(text: &str) -> TextArea<'a> {
...
pub fn build_query_textarea_widget<'a>(
    textarea: &TextArea<'a>,
    text: &str,
...
pub fn single_line_textarea_cursor_position(area: Rect, textarea: &TextArea<'_>) -> Position {
...
pub fn apply_key_event_to_textarea(textarea: &mut TextArea<'_>, key_event: KeyEvent) -> bool {
