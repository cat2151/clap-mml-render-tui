...
pub(crate) fn draw_patch_phrase(
    ...
    let area = cmrt_tui_core::ui::centered_rect(88, 84, f.area());
    ...
    let patch_phrase_query_widget = cmrt_tui_core::text_input::build_query_textarea_widget(
