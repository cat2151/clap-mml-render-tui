...
#[test]
fn handle_normal_r_does_not_repeat_within_the_same_filter_cycle() {
    let mut app = TuiApp::new_for_test(test_config());
    let patch_names = (1..=160)
...
#[path = "generate_and_patch/errors_and_overlay.rs"]
mod errors_and_overlay;
