#[derive(Clone)]
pub(crate) enum PlaybackMeasureSource {
    Empty,
...
impl PlaybackMeasureSource {
    pub(crate) fn build_log_line(&self, measure_number: usize) -> String {
        match self {
...
pub(crate) struct PlaybackMeasureAudio {
    pub(crate) samples: Vec<f32>,
    pub(crate) source: PlaybackMeasureSource,
}
...
pub(crate) struct ActiveMeasureLayer {
    samples: Vec<f32>,
    offset: usize,
}
...
pub(crate) fn mix_measure_chunk(
