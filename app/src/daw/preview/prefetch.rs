...
use crate::daw::render_queue::RenderPriority;
use crate::daw::{DawApp, FIRST_PLAYABLE_TRACK, MAX_CACHED_SAMPLES};
use crate::history::daw_cache_mml_hash;

impl DawApp {
    pub(in crate::daw) fn prefetch_preview_navigation_cache<F>(
        &self,
        current: usize,
        item_count: usize,
        page_size: usize,
    ...
    pub(in crate::daw) fn prefetch_preview_snapshot(
        &self,
        measure_index: usize,
