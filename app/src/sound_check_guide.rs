...
pub(crate) enum SoundCheckGuidePresentation {
    #[default]
    Hidden,
    Overlay,
    Footer,
...
pub(crate) struct SoundCheckGuide {
...
impl SoundCheckGuide {
    pub(crate) fn new(last_overlay_date: Option<String>) -> Self {
        Self {
    ...
    pub(crate) fn reset_for_screen(&mut self) {
    ...
    pub(crate) fn tick(&mut self, now: Instant, ready: bool, local_date: &str) -> bool {
    ...
    pub(crate) fn presentation(&self) -> SoundCheckGuidePresentation {
        self.presentation
    }

    pub(crate) fn last_overlay_date(&self) -> Option<&str> {
