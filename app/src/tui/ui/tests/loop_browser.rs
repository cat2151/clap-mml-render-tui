...
pub(super) fn browser_at_bpm(bpm: f64) -> LoopBrowser {
    browser_at_bpm_with_metadata(bpm, LoopBrowserMetadata::default())
}

pub(super) fn browser_at_bpm_with_metadata(bpm: f64, metadata: LoopBrowserMetadata) -> LoopBrowser {
    LoopBrowser::from_index(
        ...
        crate::loop_browser::persisted::PersistedDoc::in_memory(metadata),
    )
}

pub(super) fn browser_with_repeat_and_rejected_cells() -> LoopBrowser {
