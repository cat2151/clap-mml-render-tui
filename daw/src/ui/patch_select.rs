...
pub(super) fn draw_patch_select(f: &mut Frame, app: &DawApp, area: Rect) {
    ...
    let patch_query_widget = cmrt_tui_core::text_input::build_query_textarea_widget(
    ...
    let favorites_query_widget = cmrt_tui_core::text_input::build_query_textarea_widget(
