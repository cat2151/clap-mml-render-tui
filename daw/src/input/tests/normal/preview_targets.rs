...
#[test]
fn preview_target_track_uses_the_first_track_generated_from_the_chord_row() {
    ...
    assert_eq!(
        preview_target_track(&data, data.len(), crate::CHORD_TRACK),
        Some(3)
    );
}

#[test]
fn preview_target_track_rejects_a_chord_row_without_a_generated_track() {
