...
/// 現在小節の開始時刻までにクランプする。
pub(in crate::playback) fn future_chunk_append_deadline(
...
pub(in crate::playback) fn format_playback_future_append_log(
    measure_index: usize,
    append_time: Instant,
    measure_start: Instant,
...
pub(in crate::playback) fn resolved_measure_start_after_append(
