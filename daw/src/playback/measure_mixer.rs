...
#[derive(Clone)]
pub(in crate::playback) enum PlaybackMeasureSource {
    Empty,
...
impl PlaybackMeasureSource {
    pub(in crate::playback) fn build_log_line(&self, measure_number: usize) -> String {
        match self {
...
pub(in crate::playback) struct PlaybackMeasureAudio {
    pub(in crate::playback) samples: Vec<f32>,
    pub(in crate::playback) source: PlaybackMeasureSource,
}
...
pub(in crate::playback) struct ActiveMeasureLayer {
    samples: Vec<f32>,
    offset: usize,
}
...
pub(in crate::playback) fn mix_measure_chunk(
