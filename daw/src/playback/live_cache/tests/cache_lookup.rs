...
fn editing_a_cell_removes_its_cache_wav_so_that_measure_falls_silent() {
    let (_temp, _env_guard) = crate::input::tests::temp_local_dirs("live_cache_invalidates_wav");
...
fn a_row_with_no_content_still_sounds_when_a_stale_cache_wav_remains() {
    let (_temp, _env_guard) = crate::input::tests::temp_local_dirs("live_cache_stale_wav_sounds");
