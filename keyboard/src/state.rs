...
pub struct KeyboardState {
    ...
    pub patch_catalog: KeyboardPatchCatalog,
}
...
impl KeyboardState {
    ...
    pub fn velocity_mode(&self) -> VelocityMode {
        self.velocity_mode
    }

    pub fn modulation_mode(&self) -> ModulationMode {
        self.modulation_mode
    }

    pub fn pitch_bend_mode(&self) -> PitchBendMode {
        self.pitch_bend_mode
    }

    pub fn cc_periodic_on(&self) -> bool {
        self.cc_periodic_on
    }

    pub fn note_playback_mode(&self) -> NotePlaybackMode {
        self.note_playback_mode
    }

    pub fn set_detected_voicing(&mut self, voicing: PatchVoicing) {
        self.detected_voicing = voicing;
    }

    pub fn note_playback_uses_arp(&self) -> bool {
    ...
    pub fn begin_numeric_input(&mut self, target: NumericInputTarget) {
        self.numeric_input = Some(NumericInput::new(target));
    }

    pub fn numeric_input_push(&mut self, digit: char) {
    ...
    pub fn press(&mut self, note: KeyboardNote) -> Option<Vec<[u8; 3]>> {
