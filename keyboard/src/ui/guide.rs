...
use crate::guide::{KeyboardNoteGuidePresentation, KEYBOARD_NOTE_GUIDE_MESSAGE};
use cmrt_tui_core::theme::{MONOKAI_CYAN, MONOKAI_YELLOW};
...
pub(super) fn draw_note_guide_overlay(
    ...
    cmrt_tui_core::ui::draw_sound_check_guide_overlay(f, screen_area, KEYBOARD_NOTE_GUIDE_MESSAGE);
}
