...
impl KeyboardState {
    ...
    pub fn cycle_modulation(&mut self, now: Instant) -> [u8; 3] {
    ...
    pub fn cycle_pitch_bend(&mut self, now: Instant) -> [u8; 3] {
    ...
    pub fn toggle_cc_periodic(&mut self, now: Instant) -> [u8; 3] {
    ...
    pub fn take_pending_refresh_messages(&mut self, now: Instant) -> Vec<[u8; 3]> {
    ...
    pub fn combo_progress(&self) -> Option<(usize, usize)> {
